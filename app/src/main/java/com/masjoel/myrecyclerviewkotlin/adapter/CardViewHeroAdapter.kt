...
class CardViewHeroAdapter(private val listHero: ArrayList<Hero>): RecyclerView.Adapter<CardViewHeroAdapter.CardViewHolder>() {
    ...
    inner class CardViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var btnFavorit: Button = itemView.findViewById(R.id.btn_set_favorite)
    ...
    override fun onBindViewHolder(holder: CardViewHolder, position: Int) {
        ...
        holder.btnFavorit.setOnClickListener { Toast.makeText(holder.itemView.context, "Favorite " + listHero[holder.adapterPosition].name, Toast.LENGTH_SHORT).show() }
